...
var sveltesortabledocs = (function () {
    ...
    // (168:8) {#each list as todo (todo.id)}
    function create_each_block_1(key_1, ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(168:8) {#each list as todo (todo.id)}",
    		ctx
    	});
    ...
    // (167:6) <Sortable {options} bind:list>
    function create_default_slot_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(167:6) <Sortable {options} bind:list>",
    		ctx
    	});
    ...
    // (187:8) {#each list2 as todo (todo.id)}
    function create_each_block(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			attr_dev(li, "sortable-id", li_sortable_id_value = /*todo*/ ctx[9].id);
    			attr_dev(li, "class", "todo svelte-ab09md");
    			add_location(li, file$2, 187, 10, 4056);
    			this.first = li;
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, li, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(187:8) {#each list2 as todo (todo.id)}",
    		ctx
    	});
    ...
    // (186:6) <Sortable {options} bind:list={list2}>
    function create_default_slot(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(186:6) <Sortable {options} bind:list={list2}>",
    		ctx
    	});
